...
class TestSharedFileSourceCreation:
    ...
    def test_create_source_with_file_function_source(self, adapter):
        ...
        try:
            ...
            result_sql = adapter._create_source_with_file(
                "function_source", "test_func", parameters
            )
            ...
            assert (
                mock_conn._pending_files["function_source_test_func"] == temp_file_path
            )
    ...
    def test_create_source_with_file_descriptor_source(self, adapter):
        ...
        try:
            ...
            parameters = {"file": temp_file_path, "format": "protobuf"}

            result_sql = adapter._create_source_with_file(
                "descriptor_source", "event_schema", parameters
            )
            ...
            assert (
                mock_conn._pending_files["descriptor_source_event_schema"]
                == temp_file_path
            )
    ...
    def test_create_source_with_file_missing_file_param(self, adapter):
        ...
        with pytest.raises(
            dbt_common.exceptions.DbtRuntimeError, match="requires a 'file' parameter"
        ):
    ...
    def test_create_descriptor_source_with_file_wrapper(self, adapter):
        ...
        try:
            ...
            result = adapter.create_descriptor_source_with_file(
...
class TestFilePathResolution:
    ...
    def test_resolve_file_path_not_exists(self, adapter):
        ...
        with pytest.raises(
            dbt_common.exceptions.DbtRuntimeError, match="File not found"
        ):
    ...
    def test_resolve_file_path_is_directory(self, adapter):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with pytest.raises(
                dbt_common.exceptions.DbtRuntimeError, match="Path is not a file"
            ):
...
class TestBuildWithClause:
    ...
    def test_build_with_clause_quote_escaping(self, adapter):
        ...
        parameters = {"description": "Test with 'single quotes' inside"}
    ...
    def test_build_with_clause_non_string_values(self, adapter):
        ...
        parameters = {"timeout": 30, "enabled": True, "scale_factor": 1.5}
    ...
    def test_build_with_clause_mixed_values(self, adapter):
        ...
        parameters = {"name": "test", "count": 42, "active": False}
...
class TestResourceDetection:
    ...
    def test_get_function_exists_with_signature(self, adapter):
        ...
        mock_row = Mock()
        mock_row.Signature = (
            "test_func(input_values ARRAY<DOUBLE>, input_weights ARRAY<DOUBLE>)"
        )
    ...
    def test_get_function_not_exists_wrong_signature(self, adapter):
        ...
        parameters = {"args": [{"name": "input_values", "type": "ARRAY<DOUBLE>"}]}
    ...
    def test_resource_detection_sql_error_handling(self, adapter):
        ...
        unexpected_error = SQLError(
            "Unexpected error", SqlState.SQL_STATE_3D018, "statement_123"
        )
...
class TestResourceCreationIntegration:
    ...
    def test_create_deltastream_resource_unsupported_type(self, adapter):
        ...
        with pytest.raises(
            dbt_common.exceptions.DbtRuntimeError, match="Unsupported resource type"
        ):
    ...
    def test_get_resource_function_source(self, adapter):
        ...
        expected_resource = adapter.DeltastreamResource(
            "test_func", "function_source", {}
        )
    ...
    def test_get_resource_descriptor_source(self, adapter):
        ...
        expected_resource = adapter.DeltastreamResource(
            "event_schema", "descriptor_source", {}
        )
